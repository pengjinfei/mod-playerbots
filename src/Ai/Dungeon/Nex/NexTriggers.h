...
// 清怪控制链（指派/上控/不放 AoE/按序击杀）已归位到共享层：RtiTargetValue.h（判据）、RtiAction.h（动作）、
// GenericTriggers.h（触发器）、MarkRtiStrategy.h（TrashCcPullStrategy 基类）。本副本只登记治疗小怪 entry 与禁雷霆风暴。
